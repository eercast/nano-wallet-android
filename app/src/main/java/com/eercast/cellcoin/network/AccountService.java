package com.eercast.cellcoin.network;
...
import com.eercast.cellcoin.bus.SocketError;
import com.eercast.cellcoin.model.Address;
import com.eercast.cellcoin.model.Credentials;
import com.eercast.cellcoin.model.NanoWallet;
import com.eercast.cellcoin.model.PreconfiguredRepresentatives;
import com.eercast.cellcoin.network.model.BaseResponse;
import com.eercast.cellcoin.network.model.BlockTypes;
import com.eercast.cellcoin.network.model.RequestItem;
import com.eercast.cellcoin.network.model.request.AccountHistoryRequest;
import com.eercast.cellcoin.network.model.request.GetBlocksInfoRequest;
import com.eercast.cellcoin.network.model.request.PendingTransactionsRequest;
import com.eercast.cellcoin.network.model.request.ProcessRequest;
import com.eercast.cellcoin.network.model.request.SubscribeRequest;
import com.eercast.cellcoin.network.model.request.WorkRequest;
import com.eercast.cellcoin.network.model.request.block.Block;
import com.eercast.cellcoin.network.model.request.block.OpenBlock;
import com.eercast.cellcoin.network.model.request.block.ReceiveBlock;
import com.eercast.cellcoin.network.model.request.block.SendBlock;
import com.eercast.cellcoin.network.model.request.block.StateBlock;
import com.eercast.cellcoin.network.model.response.BlockInfoItem;
import com.eercast.cellcoin.network.model.response.BlockItem;
import com.eercast.cellcoin.network.model.response.BlocksInfoResponse;
import com.eercast.cellcoin.network.model.response.CurrentPriceResponse;
import com.eercast.cellcoin.network.model.response.PendingTransactionResponseItem;
import com.eercast.cellcoin.network.model.response.ProcessResponse;
import com.eercast.cellcoin.network.model.response.SubscribeResponse;
import com.eercast.cellcoin.network.model.response.TransactionResponse;
import com.eercast.cellcoin.network.model.response.WarningResponse;
import com.eercast.cellcoin.network.model.response.WorkResponse;
